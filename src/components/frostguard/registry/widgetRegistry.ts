...
export const widgetRegistry: WidgetRegistryEntry[] = [
  // ---- Customer + Admin widgets ----
  {
    ...
    component: React.lazy(() => import('../widgets/TemperatureWidget').then((m) => ({ default: m.TemperatureWidget as unknown as React.ComponentType<Record<string, unknown>> }))),
  ...
  },
  {
    ...
    component: React.lazy(() => import('../widgets/HumidityWidget').then((m) => ({ default: m.HumidityWidget as unknown as React.ComponentType<Record<string, unknown>> }))),
    defaultSize: { cols: 1, rows: 1 },
    minSize: { cols: 1, rows: 1 },
    maxSize: { cols: 2, rows: 2 },
    applicableSensorKinds: ['temp', 'combo', 'co2'],
  ...
  },
  {
    ...
    component: React.lazy(() => import('../widgets/DoorSensorWidget').then((m) => ({ default: m.DoorSensorWidget as unknown as React.ComponentType<Record<string, unknown>> }))),
  ...
  },
  {
    ...
    component: React.lazy(() => import('../widgets/BatteryWidget').then((m) => ({ default: m.BatteryWidget as unknown as React.ComponentType<Record<string, unknown>> }))),
    defaultSize: { cols: 1, rows: 1 },
    minSize: { cols: 1, rows: 1 },
  ...
  },
  {
    ...
    component: React.lazy(() => import('../widgets/AlertsWidget').then((m) => ({ default: m.AlertsWidget as unknown as React.ComponentType<Record<string, unknown>> }))),
    defaultSize: { cols: 1, rows: 2 },
    minSize: { cols: 1, rows: 1 },
  ...
  },
  {
    ...
    component: React.lazy(() => import('../widgets/ComplianceScoreWidget').then((m) => ({ default: m.ComplianceScoreWidget as unknown as React.ComponentType<Record<string, unknown>> }))),
    defaultSize: { cols: 1, rows: 1 },
    minSize: { cols: 1, rows: 1 },
    maxSize: { cols: 2, rows: 2 },
    applicableSensorKinds: ['*'],
  ...
  // ---- Admin-only widgets ----
  {
    ...
    component: React.lazy(() => import('../widgets/SignalStrengthWidget').then((m) => ({ default: m.SignalStrengthWidget as unknown as React.ComponentType<Record<string, unknown>> }))),
    defaultSize: { cols: 1, rows: 1 },
    minSize: { cols: 1, rows: 1 },
  ...
  },
  {
    ...
    component: React.lazy(() => import('../widgets/DeviceReadinessWidget').then((m) => ({ default: m.DeviceReadinessWidget as unknown as React.ComponentType<Record<string, unknown>> }))),
    defaultSize: { cols: 1, rows: 1 },
    minSize: { cols: 1, rows: 1 },
    maxSize: { cols: 2, rows: 2 },
    applicableSensorKinds: ['*'],
  ...
  },
  {
    ...
    component: React.lazy(() => import('../widgets/UplinkHistoryWidget').then((m) => ({ default: m.UplinkHistoryWidget as unknown as React.ComponentType<Record<string, unknown>> }))),
  ...
  },
  {
    ...
    component: React.lazy(() => import('../widgets/SensorSettingsWidget').then((m) => ({ default: m.SensorSettingsWidget as unknown as React.ComponentType<Record<string, unknown>> }))),
    defaultSize: { cols: 1, rows: 1 },
    minSize: { cols: 1, rows: 1 },
    maxSize: { cols: 2, rows: 2 },
    applicableSensorKinds: ['*'],
  ...
  },
  {
    ...
    component: React.lazy(() => import('../widgets/BatteryDetailWidget').then((m) => ({ default: m.BatteryDetailWidget as unknown as React.ComponentType<Record<string, unknown>> }))),
    defaultSize: { cols: 1, rows: 2 },
    minSize: { cols: 1, rows: 1 },
    maxSize: { cols: 2, rows: 2 },
    applicableSensorKinds: ['*'],
