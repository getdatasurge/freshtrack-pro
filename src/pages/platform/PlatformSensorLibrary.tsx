...
// ─── Compact seed entry factory ──────────────────────────────
function _mkSeed(
  id: string, mfr: string, model: string, name: string, kind: SensorKind,
  desc: string, ttnId: string | null, order: number, tags: string[],
  inds: IndustryVertical[], cases: Record<string, string>, subcat: string,
): SensorCatalogEntry {
  return {
    id, manufacturer: mfr, model, model_variant: null, display_name: name,
    sensor_kind: kind, description: desc,
    frequency_bands: ["US915", "EU868", "AU915", "AS923"],
    lorawan_version: "1.0.3", regional_params: null,
    supports_otaa: true, supports_abp: false, supports_class: "A",
    f_ports: [], decoded_fields: [], sample_payloads: [],
    decoder_js: null, decoder_python: null, decoder_source_url: null,
    decoder_provenance: {}, sample_payload_provenance: {},
    decoder_test_vectors: [], uplink_info: {}, battery_info: {},
    downlink_info: {}, image_url: null, datasheet_url: null,
    product_url: null, ttn_device_repo_id: ttnId,
    is_supported: true, is_visible: true, sort_order: order, tags,
    notes: null, decode_mode: "trust", temperature_unit: "C", revision: 1,
    deprecated_at: null, deprecated_reason: null,
    created_at: "2026-02-20T00:00:00Z", updated_at: "2026-02-20T00:00:00Z",
    created_by: null, repo_decoder_js: null,
    repo_decoder_source: "TheThingsNetwork/lorawan-devices @ 0db7de31",
    repo_decoder_updated_at: null, user_decoder_js: null,
    user_decoder_notes: null, user_decoder_updated_at: null,
    repo_test_fixtures: [], active_decoder_source: "repo",
    industries: inds, industry_use_cases: cases, subcategory: subcat,
  };
}
...
const SEED_CATALOG: SensorCatalogEntry[] = [
  ...
  // ─── Additional device library entries (matching migration) ──
  _mkSeed("seed-10", "Dragino", "LHT65N", "Dragino LHT65N Temperature & Humidity Sensor",
    "temp_humidity", "Next-gen indoor LoRaWAN temperature and humidity sensor with NFC provisioning and improved battery life.",
    "dragino/lht65n", 15, ["temperature", "humidity", "indoor", "nfc"],
    ["food_service", "cold_chain", "smart_building", "healthcare"],
    { food_service: "Walk-in cooler/freezer monitoring", cold_chain: "Cold storage tracking", smart_building: "Room temperature", healthcare: "Vaccine storage compliance" },
    "temperature"),
  _mkSeed("seed-11", "Dragino", "LHT52", "Dragino LHT52 Temperature & Humidity Sensor",
    "temp_humidity", "Compact indoor LoRaWAN temperature and humidity sensor. Budget-friendly for ambient monitoring.",
    "dragino/lht52", 100, ["temperature", "humidity", "indoor", "budget"],
    ["food_service", "cold_chain", "smart_building", "healthcare"],
    { food_service: "Dry storage monitoring", cold_chain: "Ambient temp tracking", smart_building: "Room temperature", healthcare: "Supply room monitoring" },
    "temperature"),
  _mkSeed("seed-12", "Dragino", "LDS03A", "Dragino LDS03A Door/Window Sensor",
    "door", "LoRaWAN door/window contact sensor with open count, duration, and alarm features.",
    "dragino/lds03a", 110, ["door", "contact", "magnetic", "alarm"],
    ["food_service", "cold_chain", "healthcare"],
    { food_service: "Walk-in door monitoring", cold_chain: "Loading dock doors", healthcare: "Medication cabinet access" },
    "door_contact"),
  _mkSeed("seed-13", "Dragino", "LSN50v2-D20", "Dragino LSN50v2-D20 Waterproof Temperature Sensor",
    "temp", "Waterproof LoRaWAN temperature sensor with dual DS18B20 probes for multi-point monitoring.",
    "dragino/lsn50v2-d20", 120, ["temperature", "waterproof", "multi-probe", "industrial"],
    ["cold_chain", "industrial", "agriculture"],
    { cold_chain: "Multi-point temp in transport", industrial: "Process temperature monitoring", agriculture: "Greenhouse zone monitoring" },
    "temperature"),
  _mkSeed("seed-14", "Dragino", "LSN50v2-S31", "Dragino LSN50v2-S31 Temperature & Humidity Sensor",
    "temp_humidity", "LoRaWAN sensor with SHT31 temperature and humidity probe. Waterproof enclosure.",
    "dragino/lsn50v2-s31", 130, ["temperature", "humidity", "waterproof", "sht31"],
    ["food_service", "smart_building", "agriculture"],
    { food_service: "Kitchen ambient monitoring", smart_building: "HVAC zone sensing", agriculture: "Barn temperature/humidity" },
    "temperature"),
  _mkSeed("seed-15", "Dragino", "LDDS75", "Dragino LDDS75 Ultrasonic Distance/Level Sensor",
    "level", "LoRaWAN ultrasonic distance sensor for liquid level monitoring. Range 28cm to 350cm.",
    "dragino/ldds75", 140, ["level", "ultrasonic", "tank", "distance"],
    ["agriculture", "industrial", "utilities"],
    { agriculture: "Water tank level", industrial: "Chemical tank monitoring", utilities: "Reservoir level" },
    "level"),
  _mkSeed("seed-16", "Dragino", "LDDS20", "Dragino LDDS20 Liquid Level Sensor",
    "level", "LoRaWAN liquid level sensor using ultrasonic measurement. Range 20cm to 200cm.",
    "dragino/ldds20", 150, ["level", "ultrasonic", "liquid", "compact"],
    ["agriculture", "industrial", "utilities"],
    { agriculture: "Irrigation tank level", industrial: "Liquid level sensing", utilities: "Water treatment level" },
    "level"),
  _mkSeed("seed-17", "Netvox", "R311G", "Netvox R311G Light Sensor",
    "light", "LoRaWAN ambient light sensor for monitoring illumination levels.",
    "netvox/r311g", 200, ["light", "lux", "illumination"],
    ["smart_building", "agriculture"],
    { smart_building: "Ambient light monitoring", agriculture: "Grow light monitoring" },
    "light"),
  _mkSeed("seed-18", "Netvox", "R312A", "Netvox R312A Emergency Push Button",
    "panic_button", "LoRaWAN wireless emergency push button with battery reporting.",
    "netvox/r312a", 210, ["panic", "button", "emergency", "alert"],
    ["smart_building", "healthcare"],
    { smart_building: "Emergency alert button", healthcare: "Staff panic button" },
    "panic_button"),
  _mkSeed("seed-19", "Netvox", "R718AB", "Netvox R718AB Temperature & Humidity Sensor",
    "temp_humidity", "LoRaWAN temperature and humidity sensor with high accuracy.",
    "netvox/r718ab", 220, ["temperature", "humidity", "indoor", "accurate"],
    ["food_service", "cold_chain", "smart_building", "healthcare"],
    { food_service: "Refrigerator monitoring", cold_chain: "Transport temp/humidity", smart_building: "Indoor climate", healthcare: "Pharma storage" },
    "temperature"),
  _mkSeed("seed-20", "Netvox", "R718DA", "Netvox R718DA Vibration Sensor (1-Axis)",
    "vibration", "LoRaWAN single-axis vibration sensor for machine health monitoring.",
    "netvox/r718da", 230, ["vibration", "accelerometer", "machine-health"],
    ["industrial"],
    { industrial: "Motor vibration monitoring" },
    "vibration"),
  _mkSeed("seed-21", "Netvox", "R718DB", "Netvox R718DB Vibration Sensor (2-Axis)",
    "vibration", "LoRaWAN dual-axis vibration sensor for equipment health monitoring.",
    "netvox/r718db", 240, ["vibration", "accelerometer", "dual-axis"],
    ["industrial"],
    { industrial: "Equipment vibration analysis" },
    "vibration"),
  _mkSeed("seed-22", "Netvox", "R718E", "Netvox R718E 3-Axis Accelerometer + Thermistor",
    "vibration", "LoRaWAN 3-axis accelerometer with integrated thermistor.",
    "netvox/r718e", 250, ["vibration", "accelerometer", "3-axis", "thermistor"],
    ["industrial"],
    { industrial: "3-axis accelerometer + thermistor for machine health" },
    "vibration"),
  _mkSeed("seed-23", "Netvox", "R718F", "Netvox R718F Door/Window Sensor",
    "door", "LoRaWAN magnetic contact sensor for door and window monitoring.",
    "netvox/r718f", 260, ["door", "contact", "magnetic"],
    ["food_service", "cold_chain", "healthcare"],
    { food_service: "Cooler door monitoring", cold_chain: "Container door", healthcare: "Restricted access monitoring" },
    "door_contact"),
  _mkSeed("seed-24", "Netvox", "R720A", "Netvox R720A Temperature & Humidity Sensor",
    "temp_humidity", "Compact LoRaWAN temperature and humidity sensor.",
    "netvox/r720a", 270, ["temperature", "humidity", "compact", "indoor"],
    ["food_service", "smart_building", "healthcare"],
    { food_service: "Kitchen climate monitoring", smart_building: "Room temp/humidity", healthcare: "Patient room monitoring" },
    "temperature"),
  _mkSeed("seed-25", "Elsys", "ERS", "Elsys ERS Indoor Environment Sensor",
    "multi_sensor", "Premium indoor environment sensor measuring temperature, humidity, light, and motion.",
    "elsys/ers", 300, ["indoor", "multi-sensor", "temperature", "humidity", "light", "motion"],
    ["smart_building"],
    { smart_building: "Indoor environment \u2014 temp, humidity, light, motion" },
    "multi_sensor"),
  _mkSeed("seed-26", "Elsys", "ERS Lite", "Elsys ERS Lite Indoor Sensor",
    "multi_sensor", "Budget-friendly indoor environment sensor with temperature, humidity, and light.",
    "elsys/ers-lite", 310, ["indoor", "multi-sensor", "budget"],
    ["smart_building"],
    { smart_building: "Budget indoor environment monitoring" },
    "multi_sensor"),
  _mkSeed("seed-27", "Elsys", "ERS Eye", "Elsys ERS Eye Occupancy Sensor",
    "occupancy", "Indoor environment sensor with people counting capability via IR array.",
    "elsys/ers-eye", 320, ["occupancy", "counting", "indoor", "ir-array"],
    ["smart_building"],
    { smart_building: "Occupancy counting + indoor environment" },
    "occupancy"),
  _mkSeed("seed-28", "Elsys", "EMS", "Elsys EMS Compact Sensor",
    "multi_sensor", "Ultra-compact LoRaWAN sensor measuring temperature and humidity.",
    "elsys/ems", 330, ["compact", "temperature", "humidity"],
    ["smart_building", "industrial"],
    { smart_building: "Compact temp/humidity", industrial: "Equipment area monitoring" },
    "multi_sensor"),
  _mkSeed("seed-29", "Elsys", "ELT-2", "Elsys ELT-2 Analog/Digital Input Sensor",
    "analog_digital", "LoRaWAN sensor with analog and digital inputs. Supports 0\u201310V and pulse counting.",
    "elsys/elt-2", 340, ["analog", "digital", "pulse", "input"],
    ["industrial", "utilities"],
    { industrial: "Generic analog/digital input", utilities: "Pulse counter for meters" },
    "analog_digital"),
  _mkSeed("seed-30", "Milesight", "EM300-MCS", "Milesight EM300-MCS Magnetic Contact Sensor",
    "door", "IP67-rated LoRaWAN magnetic contact sensor with temperature reporting.",
    "milesight-iot/em300-mcs", 410, ["door", "contact", "magnetic", "temperature", "ip67"],
    ["food_service", "cold_chain", "healthcare"],
    { food_service: "Freezer door contact", cold_chain: "Access monitoring", healthcare: "Medication fridge door" },
    "door_contact"),
  _mkSeed("seed-31", "Milesight", "EM500-CO2", "Milesight EM500-CO2 Carbon Dioxide Sensor",
    "air_quality", "LoRaWAN CO2 sensor with temperature, humidity, and barometric pressure.",
    "milesight-iot/em500-co2", 420, ["co2", "air-quality", "ndir", "temperature"],
    ["food_service", "smart_building"],
    { food_service: "Kitchen ventilation monitoring", smart_building: "Indoor air quality and CO2" },
    "air_quality"),
  _mkSeed("seed-32", "Milesight", "EM310-Tilt", "Milesight EM310-Tilt Angle Sensor",
    "tilt", "LoRaWAN tilt sensor measuring angle on multiple axes. IP67 rated.",
    "milesight-iot/em310-tilt", 450, ["tilt", "angle", "orientation", "ip67"],
    ["industrial"],
    { industrial: "Equipment tilt and angle monitoring" },
    "tilt"),
  _mkSeed("seed-33", "Tektelic", "Smart Room PIR", "Tektelic Smart Room PIR Sensor",
    "occupancy", "LoRaWAN PIR motion sensor for occupancy detection.",
    "tektelic/t00048xx-smart-room-pir", 510, ["motion", "pir", "occupancy"],
    ["smart_building"],
    { smart_building: "Motion detection and occupancy" },
    "occupancy"),
  _mkSeed("seed-34", "Laird", "RS1xx Ext Temp RTD", "Laird RS1xx External Temperature RTD Sensor",
    "temp", "LoRaWAN temperature sensor with external RTD probe. High-precision measurement.",
    "laird/rs1xx-ext-temp-rtd-sensor", 600, ["temperature", "rtd", "precision", "ultra-low"],
    ["cold_chain", "industrial", "healthcare"],
    { cold_chain: "Ultra-low freezer monitoring", industrial: "High-precision industrial temp", healthcare: "Pharma cold chain compliance" },
    "temperature"),
  _mkSeed("seed-35", "Decentlab", "DL-TP", "Decentlab DL-TP Temperature Profile Sensor",
    "temp", "LoRaWAN multi-depth temperature profiling sensor.",
    "decentlab/dl-tp", 700, ["temperature", "profile", "multi-depth"],
    ["agriculture", "industrial"],
    { agriculture: "Soil temperature profile", industrial: "Multi-point temperature profiling" },
    "temperature"),
  _mkSeed("seed-36", "SenseCap", "S2103", "SenseCap S2103 CO2/Temperature/Humidity Sensor",
    "air_quality", "LoRaWAN CO2, temperature, and humidity sensor.",
    "sensecap/sensecaps2103-co2-temp-humid", 800, ["co2", "temperature", "humidity", "air-quality"],
    ["smart_building", "agriculture"],
    { smart_building: "Indoor air quality", agriculture: "Greenhouse CO2 monitoring" },
    "air_quality"),
  _mkSeed("seed-37", "SenseCap", "Air TH", "SenseCap Air Temperature & Humidity Sensor",
    "temp_humidity", "Outdoor LoRaWAN weather-grade temperature and humidity sensor.",
    "sensecap/sensecap-air-th", 810, ["temperature", "humidity", "outdoor", "weather"],
    ["agriculture", "smart_building"],
    { agriculture: "Outdoor weather station", smart_building: "External temp reference" },
    "temperature"),
  _mkSeed("seed-38", "SenseCap", "CO2", "SenseCap CO2 Concentration Sensor",
    "air_quality", "LoRaWAN CO2 concentration sensor for greenhouses and buildings.",
    "sensecap/sensecap-co2", 820, ["co2", "ndir", "concentration"],
    ["smart_building", "agriculture"],
    { smart_building: "CO2 concentration monitoring", agriculture: "Greenhouse gas levels" },
    "air_quality"),
];
...
export default function PlatformSensorLibrary() {
  ...
  // Merge DB data with seed data — DB entries take precedence, seed fills gaps
  const catalog = useMemo(() => {
    if (!dbCatalog || dbCatalog.length === 0) return SEED_CATALOG;
    const dbKeys = new Set(dbCatalog.map((s) => `${s.manufacturer}::${s.model}`));
    const extras = SEED_CATALOG.filter((s) => !dbKeys.has(`${s.manufacturer}::${s.model}`));
    return [...dbCatalog, ...extras];
  }, [dbCatalog]);
